...
from flight.entity.artifact_entity import ModelPusherArtifact, ModelEvaluationArtifact 
...
class ModelPusher:
    ...
    def export_model(self)->ModelPusherArtifact:
        try:
            ...
            # copy model.pkl from source to destination
            shutil.copy(src=evaluated_model_file_path, dst=export_model_file_path)
            logging.info(f"Trained model: {evaluated_model_file_path} is copied in export" + \
